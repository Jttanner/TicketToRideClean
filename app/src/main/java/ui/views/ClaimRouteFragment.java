...
public class ClaimRouteFragment extends android.support.v4.app.DialogFragment implements MVP_ClaimRoute.ClaimRouteMapViewOps{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        adapter = new ClaimRouteAdapter(CModel.getInstance().getCurrGame().getUnclaimedRouteList().getRoutesFromCity(selectedCityName), CModel.getInstance().getCurrGame().getUnclaimedRouteList().getCityRouteInfoStrings(selectedCityName), getContext());
