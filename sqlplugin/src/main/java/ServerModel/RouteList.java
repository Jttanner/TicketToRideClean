...
public class RouteList {
    ...
    public RouteList(boolean initialize){
        if (initialize){
            ...
            routesAvailable.add(new Route("Dallas", "Oklahoma ServerModel.City", "Wild", 2, true));
            routesAvailable.add(new Route("Dallas", "Oklahoma ServerModel.City", "Wild", 2, true));
            routesAvailable.add(new Route("Dallas", "El Paso", "Red", 4));
            routesAvailable.add(new Route("Dallas", "Houston", "Wild", 1, true));
            routesAvailable.add(new Route("Dallas", "Houston", "Wild", 1, true));
            routesAvailable.add(new Route("Denver", "Kansas ServerModel.City", "Black", 4, true));
            routesAvailable.add(new Route("Denver", "Kansas ServerModel.City", "Orange", 4, true));
            routesAvailable.add(new Route("Denver", "Omaha", "Purple", 4));
            routesAvailable.add(new Route("Denver", "Helena", "Green", 4));
            routesAvailable.add(new Route("Denver", "Salt Lake ServerModel.City", "Red", 3, true));
            routesAvailable.add(new Route("Denver", "Salt Lake ServerModel.City", "Yellow", 3, true));
            routesAvailable.add(new Route("Denver", "Phoenix", "White", 5));
            routesAvailable.add(new Route("Denver", "Santa Fe", "Wild", 2));
            routesAvailable.add(new Route("Denver", "Oklahoma ServerModel.City", "Red", 4));
            ...
            routesAvailable.add(new Route("El Paso", "Oklahoma ServerModel.City", "Yellow", 5));
            ...
            routesAvailable.add(new Route("Helena", "Salt Lake ServerModel.City", "Purple", 3));
            routesAvailable.add(new Route("Helena", "Seattle", "Yellow", 6));
            routesAvailable.add(new Route("Houston", "New Orleans", "Wild", 2));
            routesAvailable.add(new Route("Kansas ServerModel.City", "St. Louis", "Blue", 2, true));
            routesAvailable.add(new Route("Kansas ServerModel.City", "St. Louis", "Purple", 2, true));
            routesAvailable.add(new Route("Kansas ServerModel.City", "Omaha", "Wild", 1, true));
            routesAvailable.add(new Route("Kansas ServerModel.City", "Omaha", "Wild", 1, true));
            routesAvailable.add(new Route("Kansas ServerModel.City", "Oklahoma ServerModel.City", "Wild", 2, true));
            routesAvailable.add(new Route("Kansas ServerModel.City", "Oklahoma ServerModel.City", "Wild", 2, true));
            routesAvailable.add(new Route("Las Vegas", "Salt Lake ServerModel.City", "Orange", 3));
            ...
            routesAvailable.add(new Route("Little Rock", "Oklahoma ServerModel.City", "Wild", 2));
            ...
            routesAvailable.add(new Route("Oklahoma ServerModel.City", "Santa Fe", "Blue", 3));
            ...
            routesAvailable.add(new Route("Portland", "Seattle", "Wild", 1, true));
            routesAvailable.add(new Route("Portland", "Salt Lake ServerModel.City", "Blue", 6));
            ...
            routesAvailable.add(new Route("Raleigh", "Washington", "Wild", 2, true));
            routesAvailable.add(new Route("Salt Lake ServerModel.City", "San Francisco", "Orange", 5, true));
            routesAvailable.add(new Route("Salt Lake ServerModel.City", "San Francisco", "White", 5, true));
